...
public class opcionEliminar extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new DefaultComboBoxModel(portatiles.toArray())
        );
        jComboBox1.setSelectedIndex(portatilElegido);
        jComboBox1.setSelectedItem(gestorPortatiles.r.portatiles.get(portatilElegido)
        );
        ...
        jButton2.setText(selIdioma.contenido.get(selIdioma.idiomaElegido).get(16)
        );
